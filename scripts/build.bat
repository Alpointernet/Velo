...
cl.exe /EHsc /MD /O2 /GL /nologo /I. /Foobj/ src/*.cpp src/components/*.cpp resource.res user32.lib gdi32.lib shell32.lib dwmapi.lib winmm.lib /link /LTCG /OUT:Velo.exe
if %errorlevel% neq 0 (
